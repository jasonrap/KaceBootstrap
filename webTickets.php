...
WHERE (HD_TICKET.HD_QUEUE_ID = 9) AND 
...
#echo "<tr><td><a href='http://someKbox/adminui/ticket.php?ID=$ID' target='_blank'>$ID</a></td> \n";
...
echo "<tr><td><a href='http://someKbox/adminui/ticket.php?ID=$ID' target='_blank'>$ID</a> $StatusSpan $PriortySpan</span></td> \n";
echo "<td>$Title</td> \n";
echo "<td>$Type</td> \n";
