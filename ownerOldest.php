...
while ($i < $num)
{
	...
	print("<img src='includes/img/50px_golden-star.jpg'>Congratulations $Owner, you own the oldest ticket"
		. " (<a href='http://$KaceBoxDNS/adminui/ticket.php?ID=$ID' target='_blank'>$ID</a>)!");
